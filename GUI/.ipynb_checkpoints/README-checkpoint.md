...
```bash
git clone [https://github.com/YOUR-USERNAME/Breast-Cancer-AI-Diagnosis.git](https://github.com/YOUR-USERNAME/Breast-Cancer-AI-Diagnosis.git)
...
Description: This file contains the weights trained on the BreaKHis dataset.
...
📂 File Structure
├── app.py                # Main Streamlit application script (GUI)
├── resnet18_best.pth     # Trained PyTorch model weights (The "Brain")
├── Resnet18.ipynb        # Jupyter Notebook code for training the model
├── requirements.txt      # List of dependencies
├── images/               # Folder containing screenshots for README
│   ├── ui_main.png
│   ├── result_malignant.jpg
│   └── result_benign.jpg
